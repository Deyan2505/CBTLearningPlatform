...
**Статус: `OWNER APPROVED / PLATFORM STANDARD`** (2026-09-07, след production owner review — виж
`02_CURRENT_STATUS.md`). Платформено споделен, точкуван модел за **финалния** тест на всяка routed седмица — заменя, само за
